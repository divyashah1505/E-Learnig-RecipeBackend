...
// Controller function to edit a subcategory
const editSubcategory = async (req, res) => {
  const { subcategoryId } = req.params;
  const { Sub_Category_Name, Sub_Category_Description } = req.body;
  const fileName = req.files ? Object.values(req.files) : [];
...
module.exports = { addSubcategory, getSubcategoriesByCategoryId, editSubcategory, deleteSubcategory, getAllSubcategories };
